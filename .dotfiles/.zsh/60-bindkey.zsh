# Create a new keymap, named new-keymap.
bindkey -N new-keymap
# Make the new-keymap an alias for main, so that both names refer to the same keymap.
bindkey -A new-keymap main
